...
struct qt_meta_stringdata_CLASSVideoWorkerENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSVideoWorkerENDCLASS = QtMocHelpers::stringData(
    "VideoWorker",
    "frameReady",
    "",
    "uchar*",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSVideoWorkerENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject VideoWorker::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSVideoWorkerENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSVideoWorkerENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSVideoWorkerENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void VideoWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->frameReady((*reinterpret_cast< std::add_pointer_t<uchar*>>(_a[1]))); break;
        case 1: _t->ButtonEvent(); break;
        case 2: _t->run(); break;
        default: ;
        }
        ...
        {
            using _t = void (VideoWorker::*)(uchar * );
...
void *VideoWorker::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSVideoWorkerENDCLASS.stringdata0))
...
// SIGNAL 0
void VideoWorker::frameReady(uchar * _t1)
{
